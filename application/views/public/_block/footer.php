                    ...
                    <li class="footer__item col l-4 m-6 c-12">
                        <div class="footer__info">
                            ...
                            <ul class="footer__contact">
                                ...
                                <li>
                                    <p>FAX:</p>
                                    <p class="txt-title txt-weight-bold txt-primary">+84 (24) 3933 5166</p>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <div class="footer__heading">
                                ...
                                <ul class="social__list">
                                    <li class="social__item">
                                        <a href="https://www.facebook.com/vnptepay" class="social__link" target="_blank"><i class="fab fa-facebook"></i></a>
                                    </li>
                                    <li class="social__item">
                                        <a href="https://www.linkedin.com/company/vnpt-epay" class="social__link" target="_blank"><i class="fab fa-linkedin"></i></a>
                                    </li>
                                </ul>
                                <!-- Footer social ends-->
                            </div>
